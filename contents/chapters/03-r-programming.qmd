...
A factor looks like a character variable, but it carries a defined set of **levels** --- the allowed categories and their order:
...
::: {.callout-caution collapse="true" title="Python Comparison"}
Python's type names differ slightly from R:
...
| `factor`    | `pd.Categorical`      | ordered categories |
